...
class MyScript(Script):
    ...
    def stream_events(self, inputs, ew):
        ...
        for input_name, input_item in six.iteritems(inputs.inputs):
            ...
            event.data = "number=\"%s\" and run with %s using version %s" % (str(random.uniform(minimum, maximum)), sys.executable, sys.version)
